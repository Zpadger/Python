...
#### <span id="jump">回到目录</span>

### <h3 id="1">1.最简单的生成器</h3>  
>def my_generator(n):  
&#8194;&#8195;for i in range(n):  
&#8194;&#8195;&#8194;&#8195;yield i

### <h3 id="2">2.send()方法的使用</h3>
>def my_generator(n):  
&#8194;&#8195;for i in range(n):  
&#8194;&#8195;&#8194;&#8195;temp=yield i  
&#8194;&#8195;&#8194;&#8195;print(f'我是{temp}')  
...
### <h3 id="4">4.迭代器(生成器)的send方法详解</h3>  
...
### <h3 id="6">6.生成器的启动与关闭close</h3>    
#### <h4 id="6.1">6.1生成器的启动</h4> 
...
### <h4 id="7">7.生成器的终止迭代——StopIteration</h4>    
