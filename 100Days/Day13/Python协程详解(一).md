...
### <h3 id="1">4.迭代器(生成器)的send方法详解</h3>  
...
### <h3 id="1">6.生成器的启动与关闭close</h3>    
#### <h4 id="1">6.1生成器的启动</h4> 
...
### <h4 id="1">7.生成器的终止迭代——StopIteration</h4>    
